...
{
    public class SQLRepository<TEntity> : RepositoryQueryGenerator<TEntity>, IBaseRepository<TEntity> where TEntity : class
    {
        ...
        public SQLRepository(string connectionString)
        {
            ...
            _connectionString = connectionString;
            _tableName = typeof(TEntity).GetCustomAttributes(false)[0].ToString();
            _pkProperty = "";//typeof(TEntity).GetProperties().ToList().SelectMany(a =>a.GetCustomAttributes(false));
        }
